"""
Django settings for broken_brook_45320 project.
...
ROOT_URLCONF = 'broken_brook_45320.urls'
...
WSGI_APPLICATION = 'broken_brook_45320.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_brook_45320 API",
    "DESCRIPTION": "API documentation for broken_brook_45320 App",
    "VERSION": "v1",
}
